...
define("_MB_STASK_DISPLAY_TYPE", "Display type :");
define("_MB_STASK_DISPLAY_TYPE_BLOCK", "Each item is a block");
define("_MB_STASK_DISPLAY_TYPE_BULLET", "Each item is a bullet");
define("_MB_STASK_DISPLAY_WHO_AND_WHEN", "Display the poster and date?");
define("_MB_STASK_FULLITEM", "Read the complete article");
define("_MB_STASK_HITS", "Number of hits");
...
define("_MB_STASK_WEIGHT", "List by weight");
define("_MB_STASK_WHO_WHEN", "Published by %s on %s");
//bd tree block hack
define("_MB_STASK_LEVELS", "levels");
define("_MB_STASK_CURRENTCATEGORY", "Current Category");
define("_MB_STASK_ASC", "ASC");
define("_MB_STASK_DESC", "DESC");
define("_MB_STASK_SHOWITEMS", "Show Items");
//--/bd
